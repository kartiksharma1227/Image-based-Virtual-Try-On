...
# Parts to REMOVE for agnostic image (upper body clothing + ARMS)
# FIXED: Include arms so full sleeves can be generated
UPPER_BODY_LABELS = [
    LABELS['upper_clothes'],  # 5
    LABELS['coat'],          # 7
    LABELS['dress'],         # 6
    LABELS['left_arm'],      # 14 - ARMS INCLUDED FOR FULL SLEEVES
    LABELS['right_arm'],     # 15 - ARMS INCLUDED FOR FULL SLEEVES
]
